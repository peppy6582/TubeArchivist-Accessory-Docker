...
VIDEO_DIRECTORY = os.getenv("VIDEO_DIRECTORY", "/TubeArchivist/YouTube/")
CHANNELS_DIRECTORY = os.getenv("CHANNELS_DIRECTORY", "/TubeArchivist/YouTube Channels/")
PROCESSED_FILES_TRACKER = os.getenv("PROCESSED_FILES_TRACKER", "processed_files.txt")
YOUTUBE_API_KEY = os.getenv("YOUTUBE_API_KEY", "your-youtube-api-key")
APPRISE_URL = os.getenv("APPRISE_URL")  # Optional
CHANNELS_DVR_API_REFRESH_URL = os.getenv("CHANNELS_DVR_API_REFRESH_URL")  # Optional
